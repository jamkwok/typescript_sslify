...
// Application
const SslSentry_1 = require("./SslSentry");
const SslScheduler_1 = require("./SslScheduler");
const sslSentry = new SslSentry_1.SslSentry();
const sslScheduler = new SslScheduler_1.SslScheduler();
